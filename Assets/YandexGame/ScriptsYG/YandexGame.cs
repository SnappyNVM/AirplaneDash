        ...
        public void SetLanguage(string language)
        {
            ...
            switch (language)
            {
                case "ru":
                    ...
                    { 
                        lang = language;
                        LanguagesContainer.Instance.ChangeLanguage(Languages.Russian);
                    }
                    break;
                case "en":
                    ...
                    {
                        lang = language;
                        LanguagesContainer.Instance.ChangeLanguage(Languages.English);
                    }
                    break;
                case "tr":
                    ...
                    {
                        lang = language;
                        LanguagesContainer.Instance.ChangeLanguage(Languages.Turkish);
                    }
                    else lang = "ru";
                    break;
                case "az":
